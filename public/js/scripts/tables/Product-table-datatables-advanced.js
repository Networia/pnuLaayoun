...
$(function () {
  ...
  var dtPnuTable = $('.tablepnu');
  var dtFilterable = $('.tablefilter')
  // ,
  ...
  //remove class active if hase
    ...
    //data tables
    if (dtPnuTable.length) {
      dtPnuTable.DataTable({
        processing: true,
        serverSide: true,
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                '</a>' +
                '<div class="dropdown-menu dropdown-menu-end">' +
                '<a href="'+ dtPnuTable.data('edit') + '/' + full.id +'" class="dropdown-item">' +
                feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
                'Edit</a>' +
                '</div>' +
                '</div>'
    ...
    //chi l3iba bach incluse components
    hideAll();
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '</a>' +
              '<div class="dropdown-menu dropdown-menu-end">' +
              '<a href="'+ dtFilterable.data('edit') + '/' + full.id +'" class="dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Edit</a>' +
              '</div>' +
              '</div>'
