  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <form class="auth-reset-password-form mt-2"  method="POST" action="{{ route('password.confirm') }}">
          @csrf
          <div class="mb-1">
          ...
          <button class="btn btn-primary w-100" tabindex="3">Confirm Password</button>
        </form>
