  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <form class="mt-2" method="POST" action="{{ route('two-factor.login') }}">
          @csrf
          <h6>Type your 6 digit security code</h6>
          <div class="auth-input-wrapper d-flex align-items-center justify-content-between">
            <input id="codes" type="text" class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1"
