...
@section('title', __('Nouveau Supplier'))
...
<section id="basic-input">
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="auth-register-form mt-2" method="POST" action="{{ route('supplier.store') }}">
                        @csrf
                        <div class="row">

                            <x-forms.input label="name" name="name" cols="col-3"/>
                            <x-forms.input label="phone" name="phone" cols="col-3"/>
