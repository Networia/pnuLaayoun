    ...
    <div class="modal-content">
      ...
      <div class="modal-body pb-5 px-sm-5 mx-50">
        ...
        <div class="alert alert-warning" role="alert">
          <h4 class="alert-heading">Recovery Codes :</h4>
        ...
        <form class="row gy-1" method="POST" action="/user/two-factor-authentication">
          @csrf
          @method('DElETE')

          <div class="col-12 d-flex justify-content-end">
            <button type="reset" class="btn btn-outline-primary mt-2 me-1" data-bs-dismiss="modal" aria-label="Close">
              Close
            </button>
            <button type="submit" class="btn btn-danger mt-2">
              <span class="me-50">Disable</span>
            </button>
          </div>
        </form>
      </div>
