...
@section('title', __('Éditer les informations de Categorie : '.$last->name))
...
<section id="basic-input">
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="auth-register-form mt-2" method="POST" action="{{ route('Categorie.update',request()->id) }}">
                        @csrf
                        <div class="row">
